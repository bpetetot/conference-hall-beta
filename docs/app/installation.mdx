...
* (optional) The Google Cloud Function URL: `app.gcf_url` (ex: `https://us-central1-rivieradev-db8f5.cloudfunctions.net`).
...
```
firebase functions:config:set app.url="https://myserver.com" app.gcf_url="https://us-central1-rivieradev-db8f5.cloudfunctions.net" mailgun.key="MAILGUN API KEY" mailgun.domain="YOUR DOMAIN NAME"
```
